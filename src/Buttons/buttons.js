...
export default function Buttons() {
  ...
  return (
    <div className="buttons">
      ...
      <button onClick={() => funcs.chooseAction('/')} className="btn btnDivide">/</button>
      <button onClick={() => funcs.chooseAction('*')} className="btn btnMultiply">*</button>
      <button onClick={() => funcs.chooseAction('-')} className="btn btnMinus">-</button>
      ...
      <button onClick={() => funcs.chooseAction('+')} className="btn btnPlus">+</button>
